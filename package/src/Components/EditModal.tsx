    ...
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-500 bg-opacity-50">
      <div className="bg-white p-6 rounded shadow-md w-120">
        ...
        <div className="flex flex-col mb-4">
          <label className="mb-2 text-gray-700">Search NPM Package</label>
          <input
            type="text"
        ...
        {packages.length > 0 && (
          <div className="mb-4 max-h-40 overflow-y-auto">
            <h1 className="text-lg font-bold mb-2 text-blue-700">Results</h1>
        ...
        <div className="flex flex-col mb-4">
          <label className="mb-2 text-gray-700">Edit Description</label>
          <textarea
